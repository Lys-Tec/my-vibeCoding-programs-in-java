...
import java.util.Scanner;
        ...
        // to adjust the temperature.
                       while ((temperature > 102.5 ) || (temperature > MAX_TEMP)){

        System.out.print("The temperature is too high. Turn the thermostat down and wait 5 minutes");
        
        System.out.println("Enter The Coreect Temp here: ");
        temperature = keyboard.nextDouble();
        }
