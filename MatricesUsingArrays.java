 ...
 *
 *  PROGRAM DESCRIPTION:
 *  This program performs basic Matrix Operations using Arrays as the
 *  main data structure. The user is provided with a menu to select
 ...
 *      5. Exit Program
 *
 *  The program also includes input validation using
 *  InputMismatchException to handle invalid user inputs.
 */
...
//header
public class HOUGHTON_CHIBOZYI_202301165{
        ...
        while (true) {
            try {
                ...
                if (size >= 2 && size <= 5) {
                    ...
                    System.out.println("Error: Size must be between 2 and 5.");
                }
