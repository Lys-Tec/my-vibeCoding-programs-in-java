...
System.out.println("Select an operator(+,*,-,/ or %)");
     ...
     int Division = Num1+Num2+Num3+Num4+Num5+Num6+Num7+Num8+Num9+Num10+Num11+Num12+Num13+Num14+Num15+Num16+Num17+Num18+Num19+Num20;
     int Modulus = Num1+Num2+Num3+Num4+Num5+Num6+Num7+Num8+Num9+Num10+Num11+Num12+Num13+Num14+Num15+Num16+Num17+Num18+Num19+Num20;


     //if statements to display results various operations based on the users selection
     if (operator== "+") {
            System.out.println("The Sum is " + Sum);
}

             else if(operator== "-") {
                    System.out.println("The product is " + Difference);
}

                     else if(operator== "*") {
                             System.out.println("The  Difference is " + Product);
}
             else if(operator== "/"){
